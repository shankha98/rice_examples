...
def search(query: str) -> str:
    ...
    if "rust" in query.lower():
        return ("Rust was born at Mozilla Research. Graydon Hoare started it in 2006. "
...
def store_finding(fact: str) -> str:
    ...
    try:
        ...
        slate.commit(fact, "Research Finding", action="Research", reasoning="Important fact found")
